...
public class GetX extends DoubleRepresentation {
	
	private EntityRepresentation subExpression;
	
	public GetX(EntityRepresentation subExpression) throws IllegalMaxSpeedException, IllegalPositionException, IllegalRadiusException{
