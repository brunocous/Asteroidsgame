...
public abstract class BinaryBooleanRepresentation extends BooleanRepresentation implements IComposedStructure{
	
	private IEntry argument1;
	private IEntry argument2;
	
	public BinaryBooleanRepresentation(IEntry argument1, IEntry argument2) throws IllegalOperandException{
