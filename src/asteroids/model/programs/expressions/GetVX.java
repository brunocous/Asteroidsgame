...
public class GetVX extends DoubleRepresentation {
	
	private EntityRepresentation subExpression;
	
	public GetVX(EntityRepresentation subExpression) throws IllegalMaxSpeedException, IllegalPositionException, IllegalRadiusException{
